...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            drive.adiciona(a2);
            drive.adiciona(v1);
            drive.removeVeiculo("44-WM-44");
        } catch (ExisteVeiculoException e) {
            System.out.println("Veiculo com matricula " + e.getMessage() + " ja adicionado.");
        } catch (NaoExisteVeiculoException d) {
            System.out.println("Veiculo com matricula " + d.getMessage() + " inexistente!");
        }
        ...
        /* adicionam-se repetidos para ver se ignora */
        teste.add(v2);
        teste.add(v5);
        drive.adiciona(teste);
        System.out.println("\nConjunto dos veículos adicionado ao HashMap, HashMap atualizado -> ");
        System.out.println(drive);
        System.out.println(drive.quantos());

        /* h) */
        System.out.println("\nVeiculo antes de registar aluguer: ");
        System.out.println(drive.getVeiculo("35-AA-16"));
        drive.registarAluguer("35-AA-16", 643);
        System.out.println("\nVeiculo depois de registar aluguer: ");
        System.out.println(drive.getVeiculo("35-AA-16"));

        /* i) */
        System.out.println("\nVeiculo antes de classificar: ");
        System.out.println(drive.getVeiculo("78-RG-24"));
        drive.classificarVeiculo("78-RG-24", 9);
        System.out.println("\nVeiculo depois de classificar: ");
        System.out.println(drive.getVeiculo("78-RG-24"));
        ...
        // ------------ FASE 4 ------------
        System.out.println("Ficheiro gravado!");
        try {
            drive.gravaBinario("DriveIt.obj");
        } catch (
                IOException e) {
